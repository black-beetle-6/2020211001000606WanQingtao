...
import com.WanQingtao.dao.OrderDao;
import com.WanQingtao.model.Item;
import com.WanQingtao.model.Order;
import com.WanQingtao.model.Payment;
...
public class OrderServlet extends HttpServlet {
   Connection con = null;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String message=null;
        if(customerId==0||paymentId==0||firstName==null||firstName.trim().length()==0||phone==null||phone.trim().length()==0||address1==null||
        address1.trim().length()==0||postalCode==null||postalCode.trim().length()==0
        ){
