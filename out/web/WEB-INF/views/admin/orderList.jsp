		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>order Date</td>
					<%
						com.WanQingtao.model.Order o=(com.WanQingtao.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.WanQingtao.dao.UserDao userDao=new com.WanQingtao.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.WanQingtao.model.Payment.findByPaymentId(con,n);
						%>
